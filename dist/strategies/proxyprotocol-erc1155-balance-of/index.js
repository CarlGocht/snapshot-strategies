...
async function strategy(space, network, provider, addresses, options, snapshot) {
    ...
    const apiResponse = await (0, cross_fetch_1.default)(url, {
        method: 'POST',
        headers: {
    ...
    const addressScores = await (0, erc1155_balance_of_1.strategy)(space, network, provider, flattenedWalletAddresses, options, snapshot);
