...
async function strategy(space, network, provider, addresses, options, snapshot) {
    ...
    const pools = [
        '0x88137F2a610693E975b17D7Cf940BF014CF0f325',
        '0xC35257624b01932e521bc5D9dc07e4F9ed21ED28',
        '0x14D66e676b978255C719B2771c657ACc418Bb9Fa',
    ...
    const values = {};
    Object.values(addresses).forEach((address) => (values[address] = 0));
