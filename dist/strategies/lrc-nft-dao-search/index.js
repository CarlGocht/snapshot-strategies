...
exports.author = 'raecaug';
exports.version = '0.1.2';
const LIMIT = 1000;
function makeQuery(snapshot, // This is an Ethereum block # or defaults to 'latest'
...
async function strategy(// *****Logical execution begins here; args passed in by Snapshot settings*****
space, network, provider, addresses, options, snapshot) {
    ...
    do {
        ...
        const response = await (0, utils_1.subgraphRequest)(
        ...
        snapshot, options.minter_account_id, options.tokens, skip, blacklisted_account_ids, blacklisted_nft_ids, nft_ids));
    ...
    const scores = Object.fromEntries(addresses.map((address) => [address, balances[address.toLowerCase()]]) // Map returned addresses and balances as scores array
    );
