...
const OCEAN_SUBGRAPH_URL = {
    ...
    '246': 'https://v4.subgraph.energyweb.oceanprotocol.com/subgraphs/name/oceanprotocol/ocean-subgraph',
    '1285': 'https://v4.subgraph.moonriver.oceanprotocol.com/subgraphs/name/oceanprotocol/ocean-subgraph',
    '1287': 'https://v4.subgraph.moonbase.oceanprotocol.com/subgraphs/name/oceanprotocol/ocean-subgraph',
    '80001': 'https://v4.subgraph.mumbai.oceanprotocol.com/subgraphs/name/oceanprotocol/ocean-subgraph'
};
        ...
        graphResults.pools.forEach((pool) => {
            if (pool.isFinalized) {
                pool.shares.map((share) => {
                    const userAddress = (0, address_1.getAddress)(share.user.id);
                    ...
                    const userShare = share.shares * (pool.baseTokenLiquidity / pool.totalShares);
                    if (userShare > 0.0001) {
