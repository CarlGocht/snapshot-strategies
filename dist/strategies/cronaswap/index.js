...
async function strategy(space, network, provider, addresses, options, snapshot) {
    ...
    const multicallAutoCompound = new utils_1.Multicaller(network, provider, autoCronaSwapAbi, {
        blockTag
    });
    multicallAutoCompound.call('priceShare', options.autoCrona, 'getPricePerFullShare');
    addresses.forEach((address) => {
    ...
    addresses.forEach((address) => {
        ...
        addUserBalance(userBalances, address, resultAutoCrona[address][0]
