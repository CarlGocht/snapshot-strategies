...
async function strategy(space, network, provider, addresses, options, snapshot) {
    ...
    for (const strategy of options.strategies) {
        ...
        results.push(await __1.default[strategy.name].strategy(space, strategy.network, (0, utils_1.getProvider)(strategy.network), addresses, strategy.params, blocks[strategy.network]));
    }
